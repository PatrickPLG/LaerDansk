...
var gameplay = ["Du får via tavlen midt på skærmen vist et ord der skal indgives i en af de tre følgende kategorier; Navneord (substantiv), Udsagnsord (verbum) og Tillægsord (adjektiver).\n Efter du har indgivet ordene i kategorierne kan du trykke på døren ved siden af tavlen for at afslutte øvelsen og se hvor mange rigtige du har fået."]

var overskrift = ["Ordklasser", "Generalt", "Hans/sin"]

var underskrift = ["Navneord/Substantiv", "Udsagnsord/Verber", "Tillægsord/Adjektiver"]
...
func _process(delta):
	if ordklasser == true:
		...
		$GeneralOverskrift.set_text("")
		$GeneraltTekst.set_text("")
